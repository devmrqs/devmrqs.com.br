  ...
  return (
    <div className="flex flex-row justify-start w-3xl mb-8 select-none">
      <img
        src={perfil}
        alt=""
        className="rounded-full select-none h-auto w-28"
      />
      <div className="flex flex-col ml-6 justify-center">
        ...
        <div className="flex justify-start mt-4 items-center select-none">
          ...
          <div className="bg-[rgba(116,187,113,0.2)] hover:bg-[rgba(127,187,125,0.35)] flex items-center justify-center gap-2 py-1.5 px-4 rounded-full border-[0.5px] border-[rgb(44,85,62,0.2)] duration-500">
